...
export const config = {
  ...
  worker: {
    ...
    totalTargetTimeoutMs: positiveInteger(process.env.WEBSITE_TIMEOUT ?? process.env.TOTAL_TARGET_TIMEOUT_MS ?? process.env.AUTOMATION_TIMEOUT, 120000, 300000),
    timeoutMs: positiveInteger(process.env.WEBSITE_TIMEOUT ?? process.env.TOTAL_TARGET_TIMEOUT_MS ?? process.env.AUTOMATION_TIMEOUT, 120000, 300000),
    websiteTimeoutMs: positiveInteger(process.env.WEBSITE_TIMEOUT ?? process.env.TOTAL_TARGET_TIMEOUT_MS ?? process.env.AUTOMATION_TIMEOUT, 120000, 300000),
